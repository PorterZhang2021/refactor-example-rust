...
impl Employee {
    ...
    fn set_employee_type(&mut self, arg: u8) {
        match arg {
           Employee::ENGINEER => self.employee_type = Box::new(Engineer),
            Employee::MANAGER => self.employee_type = Box::new(Manager),
            Employee::DIRECTOR => self.employee_type = Box::new(Director),
